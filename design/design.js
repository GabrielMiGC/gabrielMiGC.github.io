(function () {
  const copy = {
    en: {
      ...
      card_orkestra: "Event platform visuals, Instagram carousel cards, and loading state icon animations.",
      ...
      orkestra_lede: "Instagram cards and loading state animations for a platform with a music and event operations identity.",
      ...
      loading_body: "A set of animated loader ideas for Orkestra, using rhythm, audio, stage, and dashboard references to make waiting states feel branded.",
    ...
    pt: {
      ...
      card_orkestra: "Visual de plataforma de eventos, cards para Instagram e anima&ccedil;&otilde;es de loading states.",
      ...
      orkestra_lede: "Cards para Instagram e anima&ccedil;&otilde;es de loading states para uma plataforma com identidade de m&uacute;sica e opera&ccedil;&otilde;es de eventos.",
      qomanda_kicker: "Qomanda",
